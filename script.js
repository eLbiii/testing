...
const contests = {
    ...
    3: {
        ...
        type: 'input',
        questions: [
            { q: "В радиусе 82 м от этого учебного заведения расположены: Государственная инспекция труда в Ставропольском крае, гостиница «Ставрополь», Дворец культуры и спорта. Что это за ОУ? (Полное название)", correct: "Северо-кавказский медицинский колледж" },
            { q: "В радиусе 82 м от этого учебного заведения расположены: ТЦ Лотус, МФЦ предоставления государственных и муниципальных услуг в г. Ставрополе, Строительно-торговая компания Аква Строй. Что это за ОУ? (Полное название)", correct: "Ставропольский многопрофильный колледж" },
            { q: "В радиусе 82 м от этого учебного заведения расположены: Гимназия №30, Поликлиника №7. Что это за ОУ? (Полное название)", correct: "Колледж связи" },
            { q: "В радиусе 82 м от этого учебного заведения расположены: Средняя школа №37, ТЦ \"Союз\", Детский сад №77. Что это за ОУ? (Полное название)", correct: "Ставропольский региональный многопрофильный колледж" },
            { q: "В радиусе 82 м от этого учебного заведения расположены: Центр медицинских комиссий и справок, ЖК \"Александровский парк\", Региональный реабилитационный центр. Что это за ОУ? (Полное название)", correct: "Ставропольский кооперативный техникум" },
            { q: "В радиусе 82 м от этого учебного заведения расположены: ТЦ Космос, Магнит Экстра, Баскетбольная академия им. Дмитрия Соколова. Что это за ОУ? (Аббревиатура)", correct: "СРКВТиЭ" }
        ]
    },
    4: {
            ...
            "1-2": [
                {
                    ...
                    questions: [
                        { q: "Компьютер это -", a: ["устройство для обработки аналоговых сигналов", "устройство для хранения информации любого вида", "многофункциональное электронное устройство для работы с информацией", "электронное вычислительное устройство для обработки чисел"], correct: 2 },
                        { q: "Производительность работы компьютера (быстрота выполнения операций) зависится от:", a: ["тактовый частоты процессора", "объема обрабатываемой информации", "быстроты нажатия на клавиши", "размера экрана монитора"], correct: 0 },
                        { q: "Система взаимосвязанных технических устройств, выполняющих ввод, хранение, обработку и вывод информации называется:", a: ["программное обеспечение", "компьютерное обеспечение", "аппаратное обеспечение", "системное обеспечение"], correct: 2 },
                        { q: "Устройство для визуального воспроизведения символьной и графической информации -", a: ["процессор", "клавиатура", "сканер", "монитор"], correct: 3 },
                        { q: "Какое устройство не находится в системном блоке?", a: ["видеокарта", "процессор", "сканер", "жёсткий диск", "сетевая карта"], correct: 2 },
                        { q: "Дисковод - это устройство для", a: ["чтения/записи данных с внешнего носителя", "хранения команд исполняемой программы", "долговременного хранения информации", "обработки команд исполняемой программы"], correct: 0 },
                        { q: "Какое устройство не является периферийным?", a: ["жесткий диск", "принтер", "сканер", "модем", "web-камера"], correct: 0 },
                        { q: "Принтер с чернильной печатающей головкой, которая под давлением выбрасывает чернила из ряда мельчайших отверстий на бумагу, называется", a: ["сублимационный", "матричный", "струйный", "жёсткий", "лазерный"], correct: 2 },
                        { q: "Программа - это последовательность…", a: ["команд для компьютера", "электрических импульсов", "нулей и единиц", "текстовых знаков"], correct: 0 },
                        { q: "При выключении компьютера вся информация теряется …", a: ["на гибком диске", "на жестком диске", "на CD-ROM диске", "в оперативной памяти"], correct: 3 },
                        { q: "Для долговременного хранения пользовательской информации служит:", a: ["внешняя память", "процессор", "дисковод", "оперативная память"], correct: 0 },
                        { q: "Перед отключением компьютера информацию можно сохранить:", a: ["в оперативной памяти", "во внешней памяти", "в регистрах процессора", "на дисководе"], correct: 1 },
                        { q: "Наименьшая адресуемая часть памяти компьютера:", a: ["байт", "бит", "файл", "машинное слово"], correct: 1 },
                        { q: "Магнитный диск предназначен для:", a: ["обработки информации", "хранения информации", "ввода информации", "вывода информации"], correct: 1 },
                        { q: "Где хранится выполняемая в данный момент программа и обрабатываемые ею данные?", a: ["во внешней памяти", "в оперативной памяти", "в процессоре", "на устройстве ввода"], correct: 1 },
                        { q: "Компакт-диск, предназначенный для многократной записи новой информации называется:", a: ["CD-ROM", "CD-RW", "DVD-ROM", "CD-R"], correct: 1 },
                        { q: "Программа – это…", a: ["обрабатываемая информация, представленная в памяти компьютера в специальной форме", "электронная схема, управляющая работой внешнего устройства", "описание последовательности действий, которые должен выполнить компьютер для решения поставленной задачи обработки данных", "программно управляемое устройство для выполнения любых видов работы с информацией"], correct: 2 },
                        { q: "Информация называется данными, если она представлена…", a: ["в виде текста из учебника", "в числовом виде", "в двоичном компьютерном коде", "в виде команд для компьютера"], correct: 2 }
                    ]
                }
            ],
            "3-4": [
                {
                    ...
                    questions: [
                        { q: "Какой команды в командной строке (cmd) нет?", a: ["ping", "ipconfig", "format", "reboot"], correct: 3 },
                        { q: "Что такое IP-адрес?", a: ["Адрес сайта в интернете", "Уникальный числовой идентификатор устройства в сети", "Пароль для Wi-Fi", "Протокол передачи данных"], correct: 1 },
                        { q: "Вам дали IP-адрес 192.168.1.45 и маску подсети 255.255.255.0. Чему равен номер сети?", a: ["192.168.1.0", "192.168.0.0", "192.168.1.45", "255.255.255.0"], correct: 0 },
                        { q: "Что такое маска подсети и для чего она нужна?", a: ["Это фильтр для спама в почте", "Это настройка, которая определяет, какая часть IP-адреса относится к сети, а какая — к конкретному устройству", "Это пароль для администратора сети", "Это специальный адрес для выхода в интернет"], correct: 1 },
                ...
                },
                {
                    ...
                    questions: [
                        { q: "Что выведет этот код на Python? print(2 + 2 * 2)", a: ["6", "8", "Ошибку", "222"], correct: 0 },
                        { q: "Для чего в программировании нужен цикл?", a: ["Для красивого оформления кода", "Для многократного повторения одних и тех же действий", "Для подключения к интернету", "Для хранения данных"], correct: 1 },
                        { q: "Найдите ошибку в строке кода: if user_age = 18:", a: ["Не хватает точки с запятой", "Неправильный оператор сравнения (нужно ==)", "Не объявлена переменная user_age", "Ошибки нет"], correct: 1 },
                        { q: "Что такое переменная в программировании?", a: ["Это значение, которое не может меняться", "Это контейнер с именем, в котором хранятся данные, и эти данные можно изменять", "Это строка текста в программе", "Это ошибка в коде"], correct: 1 },
                        { q: "Дан код:\n\nnumbers = [1, 2, 3, 4, 5]\ntotal = 0\nfor num in numbers:\n    total = total + num\nprint(total)\n\nЧто выведет этот код?", a: ["15", "12345", "0", "Ошибку"], correct: 0 }
                    ]
                },
                {
                    ...
                    questions: [
                        ...
                        { q: "Какой ил следующих методов не является методом HTTP?", a: ["connect", "link", "trace", "options"], correct: 1 }
                    ]
                },
                {
                    name: "Специалист по информационным системам (3-4 курс)",
                    questions: [
                        { q: "Что такое база данных (БД)?", a: ["Стол для работы с информацией", "Программа для создания презентаций", "Упорядоченный набор данных, хранящихся в компьютере", "Системный блок компьютера"], correct: 2 },
                        { q: "Что чаще всего означает значок \"шестеренка\" 🛠 в интерфейсе программы?", a: ["Выход", "Справка", "Настройки", "Домой"], correct: 2 },
                        { q: "Компания хранит данные о клиентах в Excel-таблице. Это база данных?", a: ["Да, это полноценная база данных", "Нет, это просто электронная таблица", "Это реляционная база данных", "Это не база данных, потому что там нет формул"], correct: 1 },
                        { q: "Что такое CRM-система?", a: ["Система для управления компьютерными сетями", "Система для управления взаимоотношениями с клиентами", "Система для создания веб-сайтов", "Система для программирования"], correct: 1 },
                        { q: "В компании путаница: отдел продаж не видит, какие заказы уже выполнены, а склад не знает, какие заказы новые. Какое типовое программное решение может помочь?", a: ["Установить новую операционную систему на все компьютеры", "Купить компьютер помощнее", "Внедрить ERP- или CRM-систему, которая объединит данные всех отделов", "Купить всем сотрудникам новые телефоны"], correct: 2 }
                    ]
                },
                {
                    name: "Радиоаппаратостроение (3-4 курс)",
                    questions: [
                        { q: "Что измеряют в Амперах (А)?", a: ["Напряжение", "Сопротивление", "Силу тока", "Мощность"], correct: 2 },
                        { q: "Для чего нужен резистор в электрической цепи?", a: ["Для усиления сигнала", "Для хранения электрического заряда", "Для ограничения тока", "Для выпрямления тока"], correct: 2 },
                        { q: "Посмотрите на схему. Что нужно сделать, чтобы лампочка загорелась? (Схема: батарейка, провод, выключатель, лампочка. Выключатель разомкнут.)", a: ["Увеличить напряжение", "Замкнуть выключатель", "Добавить еще одну батарейку", "Перевернуть батарейку"], correct: 1 },
                        { q: "Что делает транзистор в большинстве электронных схем?", a: ["Создает магнитное поле", "Усиливает или переключает электрические сигналы", "Измеряет температуру", "Хранит электрический заряд"], correct: 1 },
                        { q: "В устройстве перегорел предохранитель. Какой самый важный принцип нужно соблюсти при его замене?", a: ["Вставить предохранитель большего номинала", "Вставить предохранитель такого же номинала", "Заменить предохранитель кусочком проволоки", "Перевернуть предохранитель другой стороной"], correct: 1 }
                    ]
                },
                {
                    name: "Администраторы баз данных (3-4 курс)",
                    questions: [
                        { q: "На каком языке \"разговаривают\" с большинством баз данных?", a: ["Java", "SQL", "C++", "Python"], correct: 1 },
                        { q: "Что такое запрос (query) к базе данных?", a: ["Вопрос к системному администратору", "Просьба предоставить или изменить какие-либо данные", "Жалоба на работу системы", "Новый компьютер для базы данных"], correct: 1 },
                        { q: "Какая команда отвечает за ВЫБОРКУ данных из таблицы?", a: ["DELETE", "INSERT", "SELECT", "UPDATE"], correct: 2 },
                        { q: "Что такое первичный ключ (Primary Key) в таблице базы данных?", a: ["Самый важной столбец с данными", "Столбец, который не может быть пустым", "Столбец, значения которого уникально идентифицируют каждую запись в таблице", "Пароль для доступа к базе данных"], correct: 2 },
                        { q: "Дан запрос:\n\nSELECT * FROM Users WHERE City = 'Москва' ORDER BY LastName;\n\nЧто он делает?", a: ["Удаляет всех пользователей из Москвы", "Выбирает всех пользователей из Москвы и сортирует их по фамилии", "Добавляет нового пользователя из Москвы", "Считает количество пользователей в Москве"], correct: 1 }
                    ]
                }
            ]
        }
